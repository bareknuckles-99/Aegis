...
def run_audit(target_path):
    ...
    # 1. Recon: Collect and truncate code to stay under 250k tokens
    code_context = ""
    ...
    for attempt in range(3):
        try:
            ...
            # Send the report to the GitHub UI Summary page
            ...
            # 4. Extract and Run Exploit (Inside the success block)
            ...
            return # Now we exit successfully after all steps are done
